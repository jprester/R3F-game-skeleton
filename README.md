...
Three levels are available from the briefing: **Records wing** (Operation 01), **Kaeldyn tower** (Operation 02: a high-rise floor at night with an armed east route and a camera-watched west route), and **Quiet entry**, a small mechanics demo.
